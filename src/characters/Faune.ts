...
export default class Faune extends Phaser.Physics.Arcade.Sprite {
    ...
    update(cursors: Phaser.Types.Input.Keyboard.CursorKeys) {
        ...
        if (cursors.shift?.isDown) speed *= 2
    ...
    private throwKnife() {
        ...
        if (direction !== 'side') knife.body.setSize(knife.body.height, knife.body.width)
        else knife.body.setSize(knife.body.width, knife.body.height)
